...
|                                                                                                                                                                                                                                                                               |
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[A Concept for Planetary Drilling Autonomy](https://ntrs.nasa.gov/citations/20250003932)**<br>Sarah Boelter et. al.                                                                                                                                                             |
| **ASAP-MO:  Advanced Situational Awareness and Perception for Mission-critical Operations**<br>Veronica Vannini et. al.                                                                                                                                                           |
...
| **Ariel Explores: Vision-based underwater exploration and inspection via generalist drone-level autonomy**<br>Mohit  Singh et. al.                                                                                                                                                |
| **Automated Deployment Planning for Heterogeneous Robot Teams in Disaster Response**<br>Ananya Rao et. al.                                                                                                                                                                        |
...
| **CAHSOR: Competence-Aware High-Speed Off-Road Ground Navigation in SE(3)**<br>Anuj Pokhrel et. al.                                                                                                                                                                               |
| **CU-Multi: A Dataset for Multi-Robot Data Association**<br>Doncey Albin et. al.                                                                                                                                                                                                  |
...
| **Diffusion-Based Image Augmentation for Semantic Segmentation in Outdoor Robotics**<br>Peter Mortimer et. al.                                                                                                                                                                    |
...
| **Excavation Autonomy with Resilient Traversability and Handling**<br>Yash Turkar et. al.                                                                                                                                                                                         |
| **Factor-Graph-Based Passive Acoustic Navigation for Decentralized Cooperative Localization Using Bearing Elevation Depth Difference**<br>Kalliyan Velasco et. al.                                                                                                                |
| **Feature Geometry for Stereo Sidescan and Forward-looking Sonar**<br>Kalin Norman et. al.                                                                                                                                                                                        |
...
| **From Theory to Practice: Identifying the Optimal Approach for Offset Point Tracking in the Context of Agricultural Robotics**<br>Stephane NGNEPIEPAYE WEMBE et. al.                                                                                                             |
...
| **Mapping the Catacombs: An underwater cave segment of the Devil's System**<br>Ioannis Rekleitis et. al.                                                                                                                                                                          |
...
| **Optimizing Indoor Farm Monitoring Efficiency Using UAV: Yield Estimation in a GNSS-Denied Cherry Tomato Greenhouse**<br>Hyondong Oh et. al.                                                                                                                                     |
...
| **Robotics Under Construction: Challenges on Job Sites**<br>Akhilesh Bhat et. al.                                                                                                                                                                                                 |
...
| **T-CBF: Traversability-based Control Barrier Function to Navigate Vertically Challenging Terrain**<br>Manas Gupta et. al.                                                                                                                                                        |
| **TartanGround-FR: A Large-Scale Dataset for Ground Robot Perception and Navigation in Unstructured Environments**<br>Manthan Patel et. al.                                                                                                                                       |
| **Toward Teach and Repeat Across Seasonal Deep Snow Accumulation**<br>Matej Boxan et. al.                                                                                                                                                                                         |
...
| **Uncertainty Aware Mapping for Vision-Based Underwater Robots**<br>Mohit  Singh et. al.                                                                                                                                                                                          |
